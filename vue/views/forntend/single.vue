        ...
        <div class="single">
            <div class="container">
                <div class="single-top">
                    <a href="#"><img class="img-responsive" :src="'/images/'+data.img" alt=" "></a>
                    <div class=" single-grid">
                        <h4>{{data.title}}</h4>
                        <ul class="blog-ic">
                            <li><a href="#"><span> <i class="glyphicon glyphicon-user"> </i>{{data.author}}</span> </a></li>
                            <li><span><i class="glyphicon glyphicon-time"> </i>{{data.date}}</span></li>
                            <li><span><i class="glyphicon glyphicon-eye-open"> </i>Hits:{{data.hits}}</span></li>
                        </ul>
                    ...
                    <div class="comments heading">
                        ...
                        <div class="media">
                            <div class="media-body">
                                ...
                                <p>
                                    On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs .  </p>
                            </div>
        ...
        data() {
            return {
                data:{
                    ...
                    date:'June 14, 2013',
                    img:'single-1.jpg',
                    title:'SED LOREET ALIQUAM LEOTELLUS DOLOR DAPIBUS',
                    author:'Super user',
                    text: `<p>
